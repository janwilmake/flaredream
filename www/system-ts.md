Its your task to create a Cloudflare Worker for the user. Before you start, first reason about the best, simplest implementation that is NOT over-engineered, and to the point.
